...
function createCar ({ companies }){
  ...
  const hasMatch = companyArray.some(
  ...
  async function addCar()
  {
    ...
    if (!hasMatch) {
      ...
      let Company_ID = await fetch('http://localhost:2000/api/company/getID/' + CompanyName)
      Company_ID = await Company_ID.json();
      console.log(Company_ID);
      Company_ID = Company_ID.data.Company_ID;
      let item={Company_ID,Price,Brand,Model,Year,Fuel_ID,KM,Color,Description,Image_Link}
      console.warn(item)
          ...
          <div className="login-wrap p-4 p-md-5">
            <form action="#" className="signin-form" >
              <div className="form-group mt-3">
                ...
                <input type="text" value={CompanyName} onChange={(e)=>setCompanyName(e.target.value)} className="form-control" name="CompanyName" required="" />
              </div>
              <div className="form-group mt-3">
                <label className="form-control-placeholder" htmlFor="Price">
                  Price:
                </label>
                <input type="email" value={Price} onChange={(e)=>setPrice(e.target.value)} className="form-control" name="Price" required="" />
              </div>
              <div className="form-group mt-3">
              ...
              <div className="form-group mt-3">
                ...
                <input type="text" value={Year} onChange={(e)=>setYear(e.target.value)}className="form-control" name="Year" required=""/>
              </div>
              <div className="form-group mt-3">
                <label className="form-control-placeholder" htmlFor="Fuel_ID">
                  Fuel ID: 
                </label>
                <input type="text" value={Fuel_ID} onChange={(e)=>setFuel(e.target.value)}className="form-control" name="Fuel_ID" required=""/>
              </div>  
              <div className="form-group mt-3">
                <label className="form-control-placeholder" htmlFor="km">
                  Kilometers: 
                </label>
                <input type="text" value={KM} onChange={(e)=>setKM(e.target.value)}className="form-control" name="KM" required=""/>
              </div>
              <div className="form-group mt-3">
              ...
              <div className="form-group mt-3">
                <label className="form-control-placeholder" htmlFor="Desc">
                  Description: 
                </label>
                <input type="text" value={Description} onChange={(e)=>setDesc(e.target.value)}className="form-control" name="Desc" required=""/>
              </div> 
              <div class="mb-3">
                  <label for="formFile" class="form-label">Add Image</label>
                   <input value={Image_Link} onChange={(e)=>setImgLink(e.target.value)} className="form-control" type="file"  id="formFile"/>
            </div>     
              {error && <p>{error}</p>}
